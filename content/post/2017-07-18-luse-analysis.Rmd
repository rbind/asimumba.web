...
library(xts)
LASI_yearly <- read.csv("~/R/asimumba/content/data/LUSE_yearly1.csv", header = TRUE) # End of the year price of the Lusaka Securities Exchange All Share  (LASI)

LASI_monthly <- read.csv("~/R/asimumba/content/data/LUSE_monthly1.csv", header = TRUE)

LASI_yearly_zccm <- read.csv("~/R/asimumba/content/data/LUSE_yearly2.csv", header = TRUE) # Excluding ZCCM_IH

LASI_monthly_zccm <- read.csv("~/R/asimumba/content/data/LUSE_monthly2.csv", header = TRUE)
...
knitr::include_graphics("~/R/asimumba/content/data/bloomberg.png")
```
...
knitr::include_graphics("/~/R/asimumba/content/data/bloomberg-returns.png")
```
