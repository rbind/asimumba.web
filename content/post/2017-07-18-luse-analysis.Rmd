...
```{r, first-figure,fig.cap="The LuSE LASI Monthly Returns For the Period 2005-2014 (excl. ZCCM-IH)", fig.height=3.5,fig.width=6}
...
```{r,fig.cap= "The LuSE LASI Monthly Returns For the Period 2005-2014 (incl. ZCCM-IH)", fig.height=3.5,fig.width=6}
...
```{r, fig.cap= "The LuSE LASI yearly Returns For the Period 1997-2014 (excl. ZCCM-IH)", fig.height=3.5,fig.width=6}
...
```{r, fig.cap= "The LuSE LASI yearly Returns For the Period 1997-2014 (incl. ZCCM-IH)", fig.height=3.5,fig.width=6}
