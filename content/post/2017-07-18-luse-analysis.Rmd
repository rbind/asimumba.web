...
![Source: Bloomberg](https://user-images.githubusercontent.com/24398851/30350809-f43f4b5c-9820-11e7-80fa-5cd4aa7882fe.png){width=700px height=600px}


The following excerpt from Bloomberg stands out:


    “The top 10 stock indexes that gave global investors 
    the greatest returns in 2016 were all emerging or frontier
    markets, according to data compiled by Bloomberg. That’s 
    not a fluke: over the past 20 years, nine out of 10 
    best-performing equity gauges have been in developing 
    nations, the figures show”.
...
![Source: Bloomberg](https://user-images.githubusercontent.com/24398851/30350804-ecf24f0c-9820-11e7-8b32-165181d67703.png){width=700px height=600px}
