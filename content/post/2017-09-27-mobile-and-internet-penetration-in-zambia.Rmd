...
operator_stats %>% 
  ggplot(aes(x = Population_CSO_Estimate, 
             y = Number_of_active_Subscribers, color = Number_of_active_Subscribers )) +
  geom_line() +
  geom_point() + 
...
operator_stats %>% 
  ...
  ggtitle("Mobile broadband users Vs. Mobile broadband penetration per 100 users",
           subtitle = "Over the period from 2010 - 2017, Q1 & Q2")
...
isps %>% 
  ...
  labs( 
   ...
   ggtitle("Fixed internet penetration per 100 inhabitants Vs. Number of subscribers",
           subtitle = "Over the period from 2010 - 2017, Q1 & Q2")
...
plot_ly(operator_stats,x = ~Population_CSO_Estimate,
        y = ~Number_of_active_Subscribers, mode = 'lines', autosize = FALSE,width = 500, height = 500, margin = m) 
```
